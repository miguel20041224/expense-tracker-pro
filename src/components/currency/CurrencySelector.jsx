  ...
  return (
    <div ref={containerRef} className={cn('relative', className)}>
      <button
        ...
        className="inline-flex w-full items-center justify-between gap-2 rounded-xl border border-border-subtle bg-white/5 px-3 py-2.5 text-sm font-medium text-slate-100 shadow-sm transition hover:bg-white/8 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/30 sm:w-auto sm:min-w-[11rem]"
      ...
      >
        <span className="flex min-w-0 items-center gap-2">
          ...
          <span className="truncate">
            ...
            <span className="hidden text-slate-400 sm:inline"> · {currency.country}</span>
          </span>
        </span>
        <IconChevronDown
